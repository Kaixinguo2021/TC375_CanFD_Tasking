...
#define ISR_PRIORITY_QSPI3_TX       16  /**< \brief Define the Qspi3 transmit interrupt priority.  */

#define ISR_PRIORITY_QSPI0_TX       17  /**< \brief Define the Qspi0 transmit interrupt priority.  */

#define ISR_PRIORITY_QSPI1_TX       18  /**< \brief Define the Qspi1 transmit interrupt priority.  */

#define ISR_PRIORITY_QSPI2_TX       19  /**< \brief Define the Qspi2 transmit interrupt priority.  */

#define ISR_PRIORITY_QSPI3_RX       20  /**< \brief Define the Qspi3 receive interrupt priority.  */

#define ISR_PRIORITY_QSPI0_RX       21  /**< \brief Define the Qspi0 receive interrupt priority.  */

#define ISR_PRIORITY_QSPI1_RX       22  /**< \brief Define the Qspi1 receive interrupt priority.  */

#define ISR_PRIORITY_QSPI2_RX       23  /**< \brief Define the Qspi2 receive interrupt priority.  */

#define ISR_PRIORITY_OS_TICK        24  /**< \brief Define the TFT refresh interrupt priority.  */

#define ISR_PRIORITY_ETHERNET       25  /**< \brief Define the Ethernet interrupt priority.  */
...
#define RTC_DMA_CH_TXBUFF_TO_TXFIFO        4 /**< \brief Dma channel used for RTC Master Qspi Transmit  */
#define RTC_DMA_CH_RXBUFF_FROM_RXFIFO      5 /**< \brief Dma channel used for RTC Master Qspi Receive  */
...
#define ISR_PROVIDER_RTC_ALARM      0     /**< \brief Define the RTC alarm interrupt provider.  */

#define ISR_PROVIDER_OS_TICK        0     /**< \brief Define the tft refresh interrupt provider.  */

#define ISR_PROVIDER_I2C            0     /**< \brief Define the I2c interrupt provider.  */
