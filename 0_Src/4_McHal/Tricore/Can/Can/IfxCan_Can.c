...
void IfxCan_Can_initRxMessage(IfxCan_Message *messageInfo)
{
...
void IfxCan_Can_initTxMessage(IfxCan_Message *messageInfo)
{
    const IfxCan_Message defaultMessage = {
        .bufferNumber          = 0,
        .messageId             = 0x55,
